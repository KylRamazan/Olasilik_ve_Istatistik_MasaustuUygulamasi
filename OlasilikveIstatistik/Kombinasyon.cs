...
{
    public partial class Kombinasyon : Form
    {
        public Kombinasyon()
        {
            InitializeComponent();
        ...
        private void btnHesapla_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (sayiN>=sayiR)
                {
                    ...
                    System.Numerics.BigInteger sayiRFaktoriyel = 1;
                    for(int i=1;i<=sayiR;i++)
                    {
                        sayiRFaktoriyel = sayiRFaktoriyel * i;
                    }

                    System.Numerics.BigInteger sonuc = sayiNFaktoriyel/(sayiN_RFaktoriyel*sayiRFaktoriyel);
        ...
        private void Kombinasyon_Load(object sender, EventArgs e)
        {
